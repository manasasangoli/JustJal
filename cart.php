...
$query.="insert into tblorderaddresses(UserId,MobileNumber,Ordernumber,BottleQty,Flatnobuldngno,StreetName,Area,Landmark,City) values
('$userid','$cnumber','$orderno','$BottleQty','$fnaobno','$street','$area','$lndmark','$city');";
...
<html lang="en">
<head>
<title>JUST JAL-Cart Page</title>
...
<td><input type="number" name="BottleQty" id="BottleQty" value="<?php echo $row['BottleQty'];?>" placeholder="BottleQty"  </td>	
